...
pub const BOOKING_PAGE_URL: &str = "https://irs.thsrc.com.tw/IMINT/?locale=tw";
...
impl App {
    ...
    fn start_session_with_captcha(&mut self) -> Result<String, Box<dyn Error>> {
        ...
        let path = Path::new(CAPTCHA_LOCAL_PATH);
    ...
    fn submit_train_selection(&self, train_selection: TrainSelection) -> Result<TicketConfirmation, Box<dyn Error>> {
        ...
        let response = self.client.post("https://irs.thsrc.com.tw/IMINT/?wicket:interface=:1:BookingS2Form::IFormSubmitListener")
            .headers(gen_common_headers())
    ...
    fn submit_ticket_confirmation(&self, ticket_confirmation: TicketConfirmation) -> Result<(), Box<dyn Error>> {
        ...
        let response = self.client.post("https://irs.thsrc.com.tw/IMINT/?wicket:interface=:2:BookingS3Form::IFormSubmitListener")
            .headers(gen_common_headers())
